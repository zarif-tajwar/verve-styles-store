import { InferModelFromColumns, SQL, eq, sql } from 'drizzle-orm';
...
export const getProductsFromDBSelect = async (inputSearchParams: {
  ...
  const select = qb
    ...
    .from(products)._.result;

  type lol = InferModelFromColumns<typeof products._.columns>;
