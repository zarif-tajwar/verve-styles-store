...
const ShopFilterBottomMenu = ({
  ...
  return (
    <div className="pointer-events-none sticky inset-x-0 bottom-2 z-20 flex justify-center pt-8 lg:pt-16">
      <div className="pointer-events-auto grid w-max grid-cols-[auto_auto_1fr] gap-2 rounded-xl border border-primary-100 bg-primary-0 p-2 lg:flex lg:border-none lg:p-0">
        <ShopFiltersDrawer />
