...
export const dedupedAuth = async () => {
  return {
    user: {
      name: 'Kata List',
      email: 'katalist47@gmail.com',
      image:
        'https://lh3.googleusercontent.com/a/ACg8ocINxHD9R3t9rZg4xs38WykQABD-SAneY9F8hL1JGpsB=s96-c',
      id: '01HNG5NG94KDCHMSPB82E559HT',
      role: 'USER',
      cartId: 'wVZpfLMzZO',
    },
    expires: '2024-03-28T10:03:25.361Z',
  };
};

export { dedupedAuth as auth };
